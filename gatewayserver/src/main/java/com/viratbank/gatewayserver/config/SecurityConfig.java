...
public class SecurityConfig {
    ...
    public SecurityWebFilterChain webFilterChain(ServerHttpSecurity serverHttpSecurity) {
        serverHttpSecurity.authorizeExchange(exchange -> exchange.pathMatchers(HttpMethod.GET).permitAll()
                        .pathMatchers("/viratbank/accounts/**").hasRole("ACCOUNTS")
                        .pathMatchers("/viratbank/loans/**").hasRole("LOANS")
                        .pathMatchers("/viratbank/cards/**").hasRole("CARDS"))
    ...
    private Converter<Jwt, Mono<AbstractAuthenticationToken>> grantedAuthoritiesExtractor(){
        ...
        converter.setJwtGrantedAuthoritiesConverter(new KeyclockRoleConvertor());
